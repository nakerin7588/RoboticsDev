...
#include "turtlesim_plus_interfaces/msg/detail/scanner_data__rosidl_typesupport_fastrtps_c.h"
...
using _ScannerData__ros_msg_type = turtlesim_plus_interfaces__msg__ScannerData;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ScannerData__ros_msg_type * ros_message = static_cast<const _ScannerData__ros_msg_type *>(untyped_ros_message);
  // Field name: type
  {
  ...
  void * untyped_ros_message)
{
  ...
  _ScannerData__ros_msg_type * ros_message = static_cast<_ScannerData__ros_msg_type *>(untyped_ros_message);
  // Field name: type
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _ScannerData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_turtlesim_plus_interfaces__msg__ScannerData(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = turtlesim_plus_interfaces__msg__ScannerData;
    is_plain =
      (
...
static size_t _ScannerData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_turtlesim_plus_interfaces__msg__ScannerData(
...
static message_type_support_callbacks_t __callbacks_ScannerData = {
...
static rosidl_message_type_support_t _ScannerData__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ScannerData,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtlesim_plus_interfaces, msg, ScannerData)() {
  return &_ScannerData__type_support;
}
