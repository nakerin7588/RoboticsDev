...
{
  new (message_memory) lab1_interfaces::srv::SetNoise_Request(_init);
}

void SetNoise_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<lab1_interfaces::srv::SetNoise_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SetNoise_Request_message_member_array[2] = {
  {
    ...
    offsetof(lab1_interfaces::srv::SetNoise_Request, mean),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(lab1_interfaces::srv::SetNoise_Request, variance),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SetNoise_Request_message_members = {
  "lab1_interfaces::srv",  // message namespace
  "SetNoise_Request",  // message name
  2,  // number of fields
  sizeof(lab1_interfaces::srv::SetNoise_Request),
...
{
  return &::lab1_interfaces::srv::rosidl_typesupport_introspection_cpp::SetNoise_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lab1_interfaces, srv, SetNoise_Request)() {
  return &::lab1_interfaces::srv::rosidl_typesupport_introspection_cpp::SetNoise_Request_message_type_support_handle;
}
...
void SetNoise_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) lab1_interfaces::srv::SetNoise_Response(_init);
}

void SetNoise_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<lab1_interfaces::srv::SetNoise_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SetNoise_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(lab1_interfaces::srv::SetNoise_Response, structure_needs_at_least_one_member),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SetNoise_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(lab1_interfaces::srv::SetNoise_Response),
...
{
  return &::lab1_interfaces::srv::rosidl_typesupport_introspection_cpp::SetNoise_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lab1_interfaces, srv, SetNoise_Response)() {
  return &::lab1_interfaces::srv::rosidl_typesupport_introspection_cpp::SetNoise_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers SetNoise_service_members = {
  "lab1_interfaces::srv",  // service namespace
  "SetNoise",  // service name
  // these two fields are initialized below on the first access
  // see get_service_type_support_handle<lab1_interfaces::srv::SetNoise>()
...
get_service_type_support_handle<lab1_interfaces::srv::SetNoise>()
{
  ...
  auto service_type_support =
    &::lab1_interfaces::srv::rosidl_typesupport_introspection_cpp::SetNoise_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lab1_interfaces, srv, SetNoise)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<lab1_interfaces::srv::SetNoise>();
}
