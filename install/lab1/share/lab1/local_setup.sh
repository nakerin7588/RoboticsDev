...
: ${AMENT_CURRENT_PREFIX:="/home/nakarin/RoboticsDev/install/lab1"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/lab1/environment/pythonpath.sh"
